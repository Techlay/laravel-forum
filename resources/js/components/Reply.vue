<template>
    <div :id="'reply-'+id" class="border-b border-grey-lighter py-8" :class="isBest ? 'card border-success' : 'card'">
        <div class="flex">
            <div>
                ...
                <div class="flex items-center mb-6 mt-2">
                    <div class="flex flex-1">
                        <h5 class="font-normal">
                            <a class="text-blue font-bold link" :href="'/profiles/' + reply.owner.username"
                    ...
                    <div class="text-2xs flex items-center">
                        <a v-if="authorize('owns', reply.thread) || isBest" href="#"
                           class="mr-2 font-bold flex items-center" :class="bestReplyClasses"
                           @click.prevent="markBestReply">
                            <span v-text="isBest ? 'Best Answer!' : 'Best Answer?'" class="mr-2"></span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 20 20"
                                 class="fill-current" :class="isBest ? 'text-green' : 'text-grey-light'">
