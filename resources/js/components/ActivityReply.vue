<template>
    <activity-layout>
        ...
        <div slot="heading" class="text-xl font-semibold my-4">
            <a class="text-blue font-bold mb-4" :href="activity.subject.thread.path">"{{ activity.subject.thread.title
                }}"</a>
        ...
        <div slot="badges" class="flex items-center mx-6 mb-6 text-sm">
            ...
            <div class="text-2xs flex items-center mr-2 text-xs">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 20 19" class="fill-current">
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path fill="#00DF8F"
                              d="M14.5 0c-1.74 0-3.41.81-4.5 2.09C8.91.81 7.24 0 5.5 0 2.42 0 0 2.42 0 5.5c0 3.78 3.4 6.86 8.55 11.54L10 18.35l1.45-1.32C16.6 12.36 20 9.28 20 5.5 20 2.42 17.58 0 14.5 0z"/>
                    </g>
                </svg>
            ...
            <!-- XP Badge -->
            <div class="flex items-center w-auto h-4 px-2 bg-green rounded font-semibold text-2xs text-white">XP +{{
                activity.subject.xp }}
            </div>
        </div>
    </activity-layout>
