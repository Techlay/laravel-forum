<aside class="bg-grey-lightest p-6 pr-10 border-l border-r w-64">
    ...
    <div class="widget">
        ...
        <ul class="mb-2 list-reset text-sm">
            <li class="pb-3">
                <a href="/threads"
                   class="flex items-center text-grey-darkest hover:text-blue hover:font-bold {{ Request::is('threads') && ! Request::query() ? 'text-blue font-bold' : '' }}">
            ...
            <li class="pb-3">
                <a href="/threads?popular=1"
                   class="flex items-center text-grey-darkest hover:text-blue hover:font-bold {{ Request::query('popular') ? 'text-blue font-bold' : '' }}">
            ...
            <li>
                <a href="/threads?unanswered=1"
                   class="flex items-center text-grey-darkest hover:text-blue hover:font-bold {{ Request::query('unanswered') ? 'text-blue font-bold' : '' }}">
